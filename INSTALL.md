...
2. Extract the contents of the zip file to a folder on your computer (e.g. `e.g. 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0`)
3. Add the folder to your system's PATH environment variable
4. Open a new command prompt and run `php -v` to verify PHP is installed
5. Done! You can now start using PHP.

[releases page]: https://windows.php.net/download/
```
